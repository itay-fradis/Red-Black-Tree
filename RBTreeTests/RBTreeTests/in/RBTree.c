/**********************************************
 *writer: itay fradis, itay.fradis, 205812712
 *ex3 - RED-BLACK TREE
 *finds the best price for a railway!
***********************************************/
...
{
    if (tree == NULL || tree->root == NULL || func == NULL)
    {
        return FOR_EACH_FUNC_FAIL;
    }
...
//}
//
//int printFunc(const void *object, void *args)
//{
//    if ((*(int*)object) == -1)
//    {
//        return 0;
